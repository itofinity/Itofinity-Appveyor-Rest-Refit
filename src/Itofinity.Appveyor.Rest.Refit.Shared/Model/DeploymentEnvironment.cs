...
namespace Itofinity.Appveyor.Rest.Refit.Model
{
    ...
    public partial class DeploymentEnvironment :  IEquatable<DeploymentEnvironment>, IValidatableObject
    {
        ...
        public DeploymentEnvironment(int? DeploymentEnvironmentId = default(int?), string Name = default(string), DeploymentProviderType Provider = default(DeploymentProviderType), int? AccountId = default(int?), int? ProjectsMode = default(int?), SecurityDescriptor SecurityDescriptor = default(SecurityDescriptor))
        {
